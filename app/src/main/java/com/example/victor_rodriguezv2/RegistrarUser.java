...
public class RegistrarUser extends AppCompatActivity implements View.OnClickListener{
    ...
    private void registerUser() {
        ...
        if (fullName.isEmpty()){
            editTextFullName.setError("Ingrese su Nombre completo!");
                        ...
                        if (task.isSuccessful()){
                            ...
                            FirebaseDatabase.getInstance().getReference("Users")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if (task.isSuccessful()){
                                        Toast.makeText(RegistrarUser.this,"Usuario Registado!", Toast.LENGTH_LONG).show();
                                        progressBar.setVisibility(View.GONE);
                                    }else {
                                        Toast.makeText(RegistrarUser.this,"Error al crear, intente de nuevo", Toast.LENGTH_LONG).show();
                                        progressBar.setVisibility(View.GONE);
                                    }
                                }
                            });
                            ...
                            Toast.makeText(RegistrarUser.this,"Error al crear!", Toast.LENGTH_LONG).show();
                            progressBar.setVisibility(View.GONE);
                        }
